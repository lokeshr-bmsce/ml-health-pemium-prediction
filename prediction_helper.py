...
model_young = joblib.load("artifacts\model_lt_25.joblib")
model_rest = joblib.load("artifacts\model_gt_25.joblib")
scaler_young = joblib.load("artifacts\scaler_lt_25.joblib")
scaler_rest = joblib.load("artifacts\scaler_gt_25.joblib")
...
def preprocess_input(input_dict):
    ...
    expected_columns = [
        ...
        'bmi_category_Obesity', 'bmi_category_Overweight', 'bmi_category_Underweight', 'smoking_Occasional',
        'smoking_Regular', 'employment_status_Salaried', 'employment_status_Self-Employed'
    ]
...
def predict(input_dict):
    ...
    if input_dict['Age'] <= 25:
        ...
        prediction = model_rest.predict(input_df.drop(columns=['genetical_risk']))
